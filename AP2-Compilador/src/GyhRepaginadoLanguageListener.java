...
public interface GyhRepaginadoLanguageListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GyhRepaginadoLanguageParser#operadorBooleano}.
	 * @param ctx the parse tree
	 */
	void enterOperadorBooleano(GyhRepaginadoLanguageParser.OperadorBooleanoContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhRepaginadoLanguageParser#operadorBooleano}.
	 * @param ctx the parse tree
	 */
	void exitOperadorBooleano(GyhRepaginadoLanguageParser.OperadorBooleanoContext ctx);
	/**
